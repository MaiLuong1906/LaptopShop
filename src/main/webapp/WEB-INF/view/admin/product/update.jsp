                        ...
                        <form:form method="post" action="/admin/product/update" modelAttribute="product"
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    <c:set var="nameError"><form:errors path="name" cssClass="invalid-feedback" /></c:set>
                                ...
                                <div class="mb-3 col-md-6">
                                    <c:set var="priceError"><form:errors path="price" cssClass="invalid-feedback" /></c:set>
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    <c:set var="quantityError"><form:errors path="quantity" cssClass="invalid-feedback" /></c:set>
                            ...
                            <div class="mb-3">
                                ...
                                <form:input path="shortDesc" id="shortDesc" type="text" class="form-control" />
                            </div>

                            <div class="mb-3">
                                <label for="detailDecs" class="form-label">Mô tả chi tiết:</label>
                                <form:textarea path="detailDecs" id="detailDecs" class="form-control" rows="4" />
                            </div>

                            <div class="mb-3">
                                <label for="avatarFile" class="form-label">Hình ảnh sản phẩm (để trống nếu không đổi):</label>
                                <input class="form-control" type="file" id="avatarFile"
                                    accept=".png, .jpg, .jpeg" name="file" />
                            </div>
                            <div class="mb-3">
                                <img style="max-height: 250px; ${empty product.image ? 'display: none;' : 'display: block;'}" 
                                    id="avatarPreview"
                                    src="${not empty product.image ? '/images/product/'.concat(product.image) : ''}"
                                    onerror="this.onerror=null;this.src='https://via.placeholder.com/250?text=No+Image';"
                                    alt="Product Preview" />
                            </div>
