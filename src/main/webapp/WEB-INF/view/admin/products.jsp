            ...
            <div class="page-content">
                ...
                <div class="products-table-card">
                    ...
                    <div class="card-header-bar">
                        <h5><i class="fas fa-laptop me-2" style="color: #38bdf8;"></i> Danh sách sản phẩm</h5>
                            ...
                            <tbody id="productTableBody">
                                <c:forEach var="product" items="${products}" varStatus="status">
                                    <tr class="product-row">
                                        <td style="color: #64748b; font-size: 0.82rem;">${status.count}</td>
                                        ...
                                        <td>
                                            <div class="prod-name-cell">
                                                <div class="prod-thumb-wrap">
                                                    <img
                                                        src="${not empty product.image ? pageContext.request.contextPath.concat('/images/product/').concat(product.image) : 'https://placehold.co/56x56/0f172a/38bdf8?text=N/A'}"
                                                        alt="${product.name}"
                                                        class="prod-thumb"
                                                ...
                                                <div>
                                                    <a href="${pageContext.request.contextPath}/product/detail/${product.id}"
                                                       ...
                                                       title="${product.name}">
                                                        <c:out value="${not empty product.name ? product.name : 'Chưa có tên'}" />
                                                    </a>
                                        ...
                                        <td>
                                            <span class="price-tag">
                                                ...
                                                <span style="font-size: 0.78rem; color: #818cf8;">₫</span>
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <span class="qty-tag ${product.quantity <= 5 ? 'low' : ''}">
                                                ...
                                                <c:if test="${product.quantity <= 5}">
                                                    <i class="fas fa-exclamation-triangle ms-1" style="font-size: 0.7rem;" title="Sắp hết hàng"></i>
                                                </c:if>
                                            </span>
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="7">
                                            <div class="empty-products">
                                                ...
                                                <p>Chưa có sản phẩm nào. <a href="${pageContext.request.contextPath}/admin/product/create" style="color: #38bdf8;">Thêm ngay</a></p>
                                            </div>
                                        </td>
                                    </tr>
                                </c:if>
